...
public class CidadeControle {
    ...
    public CidadeControle(Cidade objCidade, JTable jtbCidade) {
    ...
    public boolean incluir(){
        ...
        try{
            stmt = con.prepareStatement("INSERT INTO cidade(nome, cep, id_estado) VALUES(?,?,?)");
            stmt.setString(1, objCidade.getNome());
            stmt.setString(2, objCidade.getCep());
            stmt.setInt(3, objCidade.getId_estado());
    ...
    public boolean alterar(){
        ...
        try {
            stmt = con.prepareStatement("UPDATE cidade SET nome=?, cep=?, id_estado=? WHERE id_cidade=?");
            stmt.setString(1, objCidade.getNome());
            stmt.setString(2, objCidade.getCep());
            stmt.setInt(3, objCidade.getId_estado());
            stmt.setInt(4, objCidade.getId_cidade());
     ...
     public void preencher() {
        ...
        try {
            ...
            String SQL = "";
            SQL = " SELECT id_cidade, nome,cep, id_estado ";
            SQL += " FROM cidade ";
        ...
        try {
            ...
            try{
                ...
                if(rs.next() == true)
                {
                    ...
                    objCidade.setId_estado(rs.getInt(4));
                }
            }
