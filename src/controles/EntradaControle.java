...
public class EntradaControle {
    ...
    Entrada objEntrada;
    JTable jtbEntrada = null;
    
    public EntradaControle(Entrada objEntrada, JTable jtbEntrada) {
        this.objEntrada = objEntrada;
        this.jtbEntrada = jtbEntrada;
    }
    ...
    public void preencher() {
        ...
        try {
            ...
            String SQL = "";
            SQL = " SELECT id_veiculo, nome, quantidade ";
            SQL += " FROM veiculo ";
            SQL += " ORDER BY nome ";
        ...
        jtbEntrada.setModel(new DefaultTableModel(dadosTabela, cabecalhos) {
        ...
        // permite seleção de apenas uma linha da tabela
        jtbEntrada.setSelectionMode(0);

        // redimensiona as colunas de uma tabela
        TableColumn column = null;
        for (int i = 0; i <= 2; i++) {
            column = jtbEntrada.getColumnModel().getColumn(i);
            switch (i) {
                case 0:
        ...
        jtbEntrada.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
